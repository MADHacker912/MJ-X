...
Checks DDG news once per day per topic; alerts MJ when a new headline appears.
...
def _load() -> dict:
    from memory.memory_manager import load_state
    data = load_state("monitors", {})
    return data if isinstance(data, dict) else {}

def _save(monitors: dict) -> None:
    from memory.memory_manager import save_state
